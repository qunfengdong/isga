package ISGA::Handler::Gbrowse;
#------------------------------------------------------------------------

=head1 NAME

ISGA::Handler::GBrowse is an apache handler for authenticating GBrowse sessions
...
#------------------------------------------------------------------------
  sub handler {
    ...
    my $app;
    eval { $app = ISGA::Handler::WebApp->new(apache_req => $r, args => $args ) };
