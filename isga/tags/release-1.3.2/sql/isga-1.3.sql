...
SELECT pg_catalog.setval('configurationvariable_configurationvariable_id_seq', 13, true);
...
SELECT pg_catalog.setval('notificationtype_notificationtype_id_seq', 6, true);
...
SELECT pg_catalog.setval('usecase_usecase_id_seq', 225, true);
