package SysMicro::FormEngine::News;
#------------------------------------------------------------------------

=head1 NAME

SysMicro::FormEngine::News - provide forms for managing news.
...

{
  ...
  { 
    my $types = SysMicro::NewsType->query( OrderBy => 'Name' );
