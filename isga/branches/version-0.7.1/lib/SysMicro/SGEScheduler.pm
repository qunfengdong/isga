package SysMicro::SGEScheduler;
#------------------------------------------------------------------------
=pod

=head1 NAME

SysMicro::SGEScheduler contains class methods that are used to submit and 
...
BEGIN {
 ...
 !$ENV{'SGE_EXECD_PORT'}        && ($ENV{'SGE_EXECD_PORT'}="6445");
 !$ENV{'SGE_QMASTER_PORT'}      && ($ENV{'SGE_QMASTER_PORT'}="6444");
 !$ENV{'SGE_ROOT'}              && ($ENV{'SGE_ROOT'}="/cluster/sge");
 our $VERSION=0.01;
};
