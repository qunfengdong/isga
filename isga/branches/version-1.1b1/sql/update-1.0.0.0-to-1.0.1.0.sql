...
INSERT INTO clusterinput ( filetype_id, clusterinput_dependency, fileformat_id, clusterinput_ergatisformat, clusterinput_name, clusterinput_defaultvalue)
  VALUES (
    (SELECT filetype_id FROM filetype WHERE filetype_name = 'Native 454 format'),
...
UPDATE runinput a SET pipelineinput_id = b.pipelineinput_id
FROM pipelineinput b, run c
WHERE a.run_id = c.run_id AND b.pipeline_id = c.pipeline_id;
...
-------------------------------------------------------------------
-------------------------------------------------------------------
DELETE FROM variable WHERE variable_name = 'allow_sge_requests';
