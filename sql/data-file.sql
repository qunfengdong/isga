...
INSERT INTO filetype ( filetype_name, filetype_help, filecontent_id )
  VALUES ( 'RNA Function Evidence', 'Collected evidence of RNA function',
...
INSERT INTO filetype ( filetype_name, filetype_help, filecontent_id )
  VALUES ( 'Asgard Result', 'This is the data produced by Asgard.  It includes the database match identifies as well as associated EC and GO terms.', (SELECT filecontent_id FROM filecontent WHERE filecontent_name = 'Analysis Evidence'));
