...
INSERT INTO usecase ( usecase_name, usecase_requireslogin, usecase_title, usecase_stylesheet, usecase_hasdocumentation ) VALUES ( '/Home', FALSE, 'Home', '1column', TRUE);
...
INSERT INTO usecase ( usecase_name, usecase_requireslogin, usecase_title, usecase_stylesheet ) VALUES ( '/News/Create', TRUE, 'Create News Entry', '2columnright' );
INSERT INTO usecase ( usecase_name, usecase_requireslogin, usecase_title, usecase_stylesheet ) VALUES ( '/News/Edit', TRUE, 'Create News Entry', '2columnright' );

INSERT INTO usecase ( usecase_name, usecase_action, usecase_requireslogin) VALUES ( '/submit/News/Create', 'News::Create', TRUE );
INSERT INTO usecase ( usecase_name, usecase_action, usecase_requireslogin) VALUES ( '/submit/News/Edit', 'News::Edit', TRUE );
