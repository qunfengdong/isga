...
SELECT pg_catalog.setval('configurationvariable_configurationvariable_id_seq', 14, true);
...
SELECT pg_catalog.setval('ergatisinstall_ergatisinstall_id_seq', 2, true);
...
SELECT pg_catalog.setval('fileformat_fileformat_id_seq', 40, true);
...
SELECT pg_catalog.setval('filetype_filetype_id_seq', 46, true);
...
CREATE TABLE reference (
    ...
    referencetag_id integer NOT NULL
);
...
CREATE TABLE referencedb (
    ...
    referencetype_id integer NOT NULL,
...
CREATE TABLE referencerelease (
    referencerelease_id integer NOT NULL,
    reference_id integer NOT NULL,
    referencerelease_release text NOT NULL,
...
--
-- Name: referencetag; Type: TABLE; Schema: public; Owner: -; Tablespace: 
--

CREATE TABLE referencetag (
    referencetag_id integer NOT NULL,
    referencetag_name text NOT NULL
);


--
-- Name: referencetag_referencetag_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--

CREATE SEQUENCE referencetag_referencetag_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MAXVALUE
    NO MINVALUE
...
--
-- Name: referencetag_referencetag_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--

ALTER SEQUENCE referencetag_referencetag_id_seq OWNED BY referencetag.referencetag_id;


--
-- Name: referencetag_referencetag_id_seq; Type: SEQUENCE SET; Schema: public; Owner: -
--

SELECT pg_catalog.setval('referencetag_referencetag_id_seq', 1, false);


--
-- Name: referencetype; Type: TABLE; Schema: public; Owner: -; Tablespace: 
--

CREATE TABLE referencetype (
    referencetype_id integer NOT NULL,
    referencetype_name text NOT NULL,
    filetype_id integer NOT NULL,
    fileformat_id integer NOT NULL
);
...
--
-- Name: referencetype_referencetype_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--

CREATE SEQUENCE referencetype_referencetype_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MAXVALUE
    NO MINVALUE
...
--
-- Name: referencetype_referencetype_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--

ALTER SEQUENCE referencetype_referencetype_id_seq OWNED BY referencetype.referencetype_id;


--
-- Name: referencetype_referencetype_id_seq; Type: SEQUENCE SET; Schema: public; Owner: -
--

SELECT pg_catalog.setval('referencetype_referencetype_id_seq', 1, false);
...
CREATE TABLE runningscript (
    ...
    runningscript_pid integer NOT NULL,
...
SELECT pg_catalog.setval('siteconfiguration_siteconfiguration_id_seq', 6, true);
...
--
-- Name: referencetag_id; Type: DEFAULT; Schema: public; Owner: -
--

ALTER TABLE referencetag ALTER COLUMN referencetag_id SET DEFAULT nextval('referencetag_referencetag_id_seq'::regclass);


--
-- Name: referencetype_id; Type: DEFAULT; Schema: public; Owner: -
--

ALTER TABLE referencetype ALTER COLUMN referencetype_id SET DEFAULT nextval('referencetype_referencetype_id_seq'::regclass);
...
COPY component (component_id, component_name, component_ergatisname, cluster_id, componenttemplate_id, component_index, component_dependson, component_copyparametermask, component_subclass, ergatisinstall_id) FROM stdin;
\.
...
COPY reference (reference_id, reference_name, reference_path, reference_description, referencetag_id) FROM stdin;
\.
...
COPY referencedb (referencedb_id, referencetype_id, referencerelease_id, pipelinestatus_id, referencedb_path) FROM stdin;
\.
...
COPY referencerelease (referencerelease_id, reference_id, referencerelease_release, referencerelease_version, referencerelease_path) FROM stdin;
\.


--
-- Data for Name: referencetag; Type: TABLE DATA; Schema: public; Owner: -
--

COPY referencetag (referencetag_id, referencetag_name) FROM stdin;
\.


--
-- Data for Name: referencetype; Type: TABLE DATA; Schema: public; Owner: -
--

COPY referencetype (referencetype_id, referencetype_name, filetype_id, fileformat_id) FROM stdin;
\.
...
COPY runningscript (runningscript_id, runningscript_pid, runningscript_createdat, runningscript_command) FROM stdin;
\.
...
--
-- Name: reference_reference_path_key; Type: CONSTRAINT; Schema: public; Owner: -; Tablespace: 
--

ALTER TABLE ONLY reference
    ADD CONSTRAINT reference_reference_path_key UNIQUE (reference_path);
...
--
-- Name: referencerelease_referencerelease_release_key; Type: CONSTRAINT; Schema: public; Owner: -; Tablespace: 
--

ALTER TABLE ONLY referencerelease
    ADD CONSTRAINT referencerelease_referencerelease_release_key UNIQUE (referencerelease_release);


--
-- Name: referencetag_pkey; Type: CONSTRAINT; Schema: public; Owner: -; Tablespace: 
--

ALTER TABLE ONLY referencetag
    ADD CONSTRAINT referencetag_pkey PRIMARY KEY (referencetag_id);


--
-- Name: referencetag_referencetag_name_key; Type: CONSTRAINT; Schema: public; Owner: -; Tablespace: 
--

ALTER TABLE ONLY referencetag
    ADD CONSTRAINT referencetag_referencetag_name_key UNIQUE (referencetag_name);


--
-- Name: referencetype_pkey; Type: CONSTRAINT; Schema: public; Owner: -; Tablespace: 
--

ALTER TABLE ONLY referencetype
    ADD CONSTRAINT referencetype_pkey PRIMARY KEY (referencetype_id);


--
-- Name: referencetype_referencetype_name_key; Type: CONSTRAINT; Schema: public; Owner: -; Tablespace: 
--

ALTER TABLE ONLY referencetype
    ADD CONSTRAINT referencetype_referencetype_name_key UNIQUE (referencetype_name);
...
--
-- Name: reference_referencetag_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY reference
    ADD CONSTRAINT reference_referencetag_id_fkey FOREIGN KEY (referencetag_id) REFERENCES referencetag(referencetag_id);


--
-- Name: referencedb_pipelinestatus_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY referencedb
    ADD CONSTRAINT referencedb_pipelinestatus_id_fkey FOREIGN KEY (pipelinestatus_id) REFERENCES pipelinestatus(pipelinestatus_id);
...
--
-- Name: referencedb_referencetype_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY referencedb
    ADD CONSTRAINT referencedb_referencetype_id_fkey FOREIGN KEY (referencetype_id) REFERENCES referencetype(referencetype_id);
...
--
-- Name: referencetype_fileformat_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY referencetype
    ADD CONSTRAINT referencetype_fileformat_id_fkey FOREIGN KEY (fileformat_id) REFERENCES fileformat(fileformat_id);


--
-- Name: referencetype_filetype_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY referencetype
    ADD CONSTRAINT referencetype_filetype_id_fkey FOREIGN KEY (filetype_id) REFERENCES filetype(filetype_id);
