package ISGA::ClusterBuilder;

#------------------------------------------------------------------------

=head1 NAME

B<ISGA::ClusterBuilder> manages loading YAML definitions for pipeline clusters, and providing FormEngine parameter arrays.
...
=item public ISGA::ClusterBuilder new(Cluster $cluster);
