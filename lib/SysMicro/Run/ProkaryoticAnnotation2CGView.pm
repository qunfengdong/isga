...
################################ CGVIEW BLOCK BEGIN ###############################################
#	my $cgv_trna = "<feature color=\"orange\" decoration=\"arc\" label=\"$name\" hyperlink=\"/GenomeFeature/View?genome_feature=$id\""; 
################################# CGVIEW BLOCK END ################################################
...
################################ CGVIEW BLOCK BEGIN ###############################################
#	$cgv_trna .= ">\n<featureRange start=\"$start\" stop=\"$end\" />\n</feature>\n";
#	if ($feature->strand) {
#		$cgv_plus .= $cgv_trna;
#	} else {
#		$cgv_minus .= $cgv_trna;
...
################################ CGVIEW BLOCK BEGIN ###############################################
#	my $cgv_rrna = "<feature color=\"green\" decoration=\"arc\" label=\"$name\" hyperlink=\"/GenomeFeature/View?genome_feature=$id\""; 
################################# CGVIEW BLOCK END ################################################
...
################################ CGVIEW BLOCK BEGIN ###############################################
#	my $cgv_mrna = " label=\"$name\" hyperlink=\"/GenomeFeature/View?genome_feature=$id\""; 
################################# CGVIEW BLOCK END ################################################
...
#	$cgv_mrna .= ">\n<featureRange start=\"$start\" stop=\"$end\" />\n</feature>\n";
#	if ($feature->strand) {
#		$cgv_plus .= "<feature color=\"red\" decoration=\"clockwise-arrow\"" . $cgv_mrna;
#	} else {
#		$cgv_minus .= "<feature color=\"blue\" decoration=\"counterclockwise-arrow\"" . $cgv_mrna;
#	}
################################# CGVIEW BLOCK END ################################################
...
################################ CGVIEW BLOCK BEGIN ###############################################
    open CGVIEW_CONF '>', '___FILENAME___';
    print CGVIEW_CONF "<?xml version=\"1.0\" encoding=\"ISO-8859-1\"?>\n";
    print CGVIEW_CONF "<cgview backboneRadius=\"200\" sequenceLength=\"___SEQUENCE_LENGTH___\" height=\"500\" width=\"500\" titleFont=\"SansSerif, plain, 18\" title=\"Strain K12, MG1655\" globalLabel=\"auto\" moveInnerLabelsToOuter=\"false\" featureThickness=\"xx-large\" tickLength=\"small\" shortTickColor=\"black\" longTickColor=\"black\" zeroTickColor=\"black\" showBorder=\"false\">\n";
    print CGVIEW_CONF "<legend position=\"upper-right\" font=\"SanSerif, plain, 10\" backgroundOpacity=\"0.8\">\n";
    print CGVIEW_CONF "<legendItem text=\"Features\" font=\"SanSerif, plain, 12\"/>\n";
    print CGVIEW_CONF "<legendItem text=\"+ Strand\" drawSwatch=\"true\" swatchColor=\"red\"/>\n";
    print CGVIEW_CONF "<legendItem text=\"- Strand\" drawSwatch=\"true\" swatchColor=\"blue\"/>\n";
    print CGVIEW_CONF "<legendItem text=\"tRNA\" drawSwatch=\"true\" swatchColor=\"orange\"/>\n";
    print CGVIEW_CONF "<legendItem text=\"rRNA\" drawSwatch=\"true\" swatchColor=\"green\"/>\n";
    print CGVIEW_CONF "</legend>\n";
    print CGVIEW_CONF "<featureSlot strand=\"direct\">\n";
    print CGVIEW_CONF $cgv_plus;
    print CGVIEW_CONF "</featureSlot>\n";
    print CGVIEW_CONF "<featureSlot strand=\"reverse\">\n";
    print CGVIEW_CONF $cgv_minus;
    print CGVIEW_CONF "</featureSlot>\n";
    print CGVIEW_CONF "</cgview>\n";
    close CGVIEW_CONF;
################################# CGVIEW BLOCK END ################################################
