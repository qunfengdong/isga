...
sub SelectInputList {
  ...
  my $sample_data = $type->getName eq 'ORF Prediction Raw Evidence' ? '<a href="/sample_data.predict">Download Sample Data</a>' : '<a href="/sample_data.fna">Download Sample Data</a>';
