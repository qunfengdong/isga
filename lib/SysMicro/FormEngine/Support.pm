package SysMicro::FormEngine::Support;
#------------------------------------------------------------------------

=head1 NAME

SysMicro::FormEngine::Support - provide support forms.
...
sub ContactUs {
  ...
  $form->conf( { ACTION => '/submit/Support/ContactUs',
		 FORMNAME => 'support_contact_us',
